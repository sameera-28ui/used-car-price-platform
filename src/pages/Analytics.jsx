...
// Price trend data based on brand
const brandPriceTrend = {
  Maruti:     [{ year:"2020", price:4.2 },{ year:"2021", price:4.8 },{ year:"2022", price:5.3 },{ year:"2023", price:5.8 },{ year:"2024", price:6.1 },{ year:"2025", price:6.4 }],
  Hyundai:    [{ year:"2020", price:5.5 },{ year:"2021", price:6.2 },{ year:"2022", price:7.0 },{ year:"2023", price:7.8 },{ year:"2024", price:8.3 },{ year:"2025", price:8.7 }],
  Tata:       [{ year:"2020", price:5.0 },{ year:"2021", price:5.8 },{ year:"2022", price:6.5 },{ year:"2023", price:7.2 },{ year:"2024", price:7.8 },{ year:"2025", price:8.1 }],
  Honda:      [{ year:"2020", price:6.0 },{ year:"2021", price:6.8 },{ year:"2022", price:7.5 },{ year:"2023", price:8.2 },{ year:"2024", price:8.8 },{ year:"2025", price:9.1 }],
  Mahindra:   [{ year:"2020", price:7.0 },{ year:"2021", price:8.0 },{ year:"2022", price:9.2 },{ year:"2023", price:10.5 },{ year:"2024", price:11.8 },{ year:"2025", price:12.5 }],
  Toyota:     [{ year:"2020", price:8.0 },{ year:"2021", price:9.2 },{ year:"2022", price:10.5 },{ year:"2023", price:12.0 },{ year:"2024", price:13.5 },{ year:"2025", price:14.2 }],
  default:    [{ year:"2020", price:6.0 },{ year:"2021", price:7.0 },{ year:"2022", price:8.0 },{ year:"2023", price:9.0 },{ year:"2024", price:10.0 },{ year:"2025", price:10.5 }],
};
...
// Resale value by ownership
const ownershipResale = [
  { owner: "1st Owner", resale: 95 },
  { owner: "2nd Owner", resale: 78 },
  { owner: "3rd Owner", resale: 62 },
  { owner: "4th Owner", resale: 48 },
  { owner: "5th Owner+", resale: 35 },
];
...
function Analytics() {
  ...
  const priceTrend = brandPriceTrend[predictionData.brand] || brandPriceTrend.default;
